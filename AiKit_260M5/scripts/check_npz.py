...
# #加载相机纠正参数
# camera_matrix = load['mtx']
# dist_matrix =  load['dist']
...
# 摄像头的畸变系数
dist_matrix = np.array([[3.41360787e-01, -2.52114260e+00, -1.28012469e-03,  6.70503562e-03,
        2.57018000e+00]])
...
#    如果找不打id
    if ids is not None:
        ...
        ###### 距离估计 #####
        # distance = ((tvec[0][0][2] + 0.02) * 0.0254) * 1  # 单位是米
        distance = (tvec[0][0][2]) * 100  # 单位是米


        # 显示距离
        cv2.putText(frame, 'distance:' + str(round(distance, 4)), (0, 110), font, 1, (0, 255, 0), 2,
                    cv2.LINE_AA)
